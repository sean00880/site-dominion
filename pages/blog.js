						...
						<ul className="industify_fn_postlist">
							...
							<li>
								<div className="post has-post-thumbnail">
									...
									<div className="img_holder">
										<Link href="/blog-single-1"><a><img src=" /images/1.jpg" alt="" /></a></Link>
							...
							<li>
								<div className="post has-post-thumbnail">
									...
									<div className="img_holder">
										<Link href="/blog-single-2"><a><img src=" /images/1.jpg" alt="" /></a></Link>
										<span className="shape1"></span><span className="shape2"></span>
									</div>
									<div className="content_holder">
										<div className="info_holder">
							...
							<li>
								<div className="post has-post-thumbnail">
									...
									<div className="img_holder">
										<Link href="/blog-single-3"><a><img src=" /images/1.jpg" alt="" /></a></Link>
										<span className="shape1"></span><span className="shape2"></span>
									</div>
									<div className="content_holder">
										<div className="info_holder">
