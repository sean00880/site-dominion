...
const About = () => {
    return (
        <section className="about-area" style={{"minHeight":"100vh", "justifyContent":"center", "display":"flex","flex-direction":"column", "padding":"10vh 1.4vh", "borderBottom":"2px solid #b64c4c"}}>
